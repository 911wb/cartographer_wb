...
PointCloud AdaptivelyVoxelFiltered(
    ...
    const PointCloud& point_cloud)// TODO: 
{
  // param: adaptive_voxel_filter.min_num_points = 200 满足小于等于这个值的点云满足要求, 足够稀疏
    ...
    const proto::AdaptiveVoxelFilterOptions& options) 
{
  return AdaptivelyVoxelFiltered(
      ...
      // 这里的最大距离是相对于local坐标系原点的 P_origin
